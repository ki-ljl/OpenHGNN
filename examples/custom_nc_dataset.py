...
class MyMultiLabelNCDataset(DGLDataset):
    ...
    def process(self):
        ...
        self._g = generate_random_nc_hg(multi_label=True)
...
def generate_random_nc_hg(multi_label=False) -> DGLHeteroGraph:
    num_classes = 5
    num_edges_dict = {
...
def train_with_customized_dataset(dataset):
...
if __name__ == '__main__':
    ...
    train_with_customized_dataset(myMultiLabelNCDataset)
